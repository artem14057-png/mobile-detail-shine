          ...
          <div className="flex items-center justify-between py-3">
            ...
            <Link to="/" className="flex items-center group shrink-0">
              <img
                ...
                alt="BM Detailing"
                className="h-14 md:h-16 lg:h-20 w-auto object-contain transition-all duration-300 group-hover:scale-105" src="/lovable-uploads/33edb61c-a320-4266-9452-c44a3f0b2fbc.png" />
